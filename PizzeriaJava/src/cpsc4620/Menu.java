...
public class Menu {
	...
	public static void EnterOrder() throws SQLException, IOException 
	{
		...
		if (choice == 1){
			...
			if (exists.equals("y")) {
				...
				userChoice = reader.readLine();
				int custID = Integer.parseInt(userChoice);
		...
		if(userChoice.equals("y")){
			...
			while(discID != -1) {
				...
				userChoice = reader.readLine();
				discID = Integer.parseInt(userChoice);
			}
		}

		//Discount discount = new Discount(discID, "Name", 15, true);
		Order order = new Order(1, 1, type, "2023-03-05", 20.75, 3.68, 0);
	...
	public static void EnterCustomer() throws SQLException, IOException 
	{
		...
		// User Input Prompts...
		 ...
		 Customer customer = new Customer(10, firstName, lastName, phone);
	...
	public static void ViewOrders() throws SQLException, IOException 
	{
		...
		* 
		*/
		ArrayList<Order> order1 = DBNinja.getOrders(true);
		ArrayList<Order> order2 = DBNinja.getOrders(false);
		/*if(order1.isEmpty() || order2.isEmpty()){
	...
	public static void MarkOrderAsComplete() throws SQLException, IOException 
	{
		...
		String userChoice = reader.readLine();
		int choice = Integer.parseInt(userChoice);
		Order order = new Order(choice, 1, "N/A", "N/A", 0.0, 0.0, 0);
		if(choice > order1.size()){
	...
	public static void AddInventory() throws SQLException, IOException 
	{
		...
		userChoice = reader.readLine();
		Double choice2 = Double.parseDouble(userChoice);
		Double toAdd = choice2;

		Topping t = new Topping(choice, "Name", 5, 10, 15, 20, 5, 1, 1, 10);
		DBNinja.addToInventory(t, toAdd);
	}
	...
	public static Pizza buildPizza(int orderID) throws SQLException, IOException 
	{
		...
		ArrayList<Topping> placed = new ArrayList<>();
		choice = 0;
		while(choice != -1){
			...
			choice = Integer.parseInt(userChoice);
			if(choice == -1) break;
			placed.add(tops.get(choice));
			System.out.println("Do you want to add extra topping? Enter y/n");
			userChoice = reader.readLine();
			Topping topping = tops.get(choice);
			if(userChoice.equals("y") || userChoice.equals("Y"))
			{
				if(topping.getCurINVT() <= topping.getMinINVT())
				{
